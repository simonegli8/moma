...
namespace MoMAExtractor
{
	static class AssemblyManager
	{
		...
		private static string mono_451 = @"C:\Program Files (x86)\Mono\lib\mono\4.5.1-api";
		private static string mono_452 = @"C:\Program Files (x86)\Mono\lib\mono\4.5.2-api";
		private static string mono_46 = @"C:\Program Files (x86)\Mono\lib\mono\4.6-api";
		private static string mono_461 = @"C:\Program Files (x86)\Mono\lib\mono\4.6.1-api";
		private static string mono_462 = @"C:\Program Files (x86)\Mono\lib\mono\4.6.2-api";
		private static string mono_47 = @"C:\Program Files (x86)\Mono\lib\mono\4.7-api";
